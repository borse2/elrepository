...
for i in range (100000):
    ...
    if tortoise_pos >= finish_line:
        #print(f"🐢 The Tortoise wins! | Tortoise Wins: {tortoise_wins}")
        tortoise_wins=tortoise_wins+1
    else:
        #print(f"🐇 The Hare wins! | Hare Wins: {hare_wins}")
        hare_wins=hare_wins+1
    tortoise_pos=0
    hare_pos=0
print(f"Hare wins: {hare_wins} | Percentage: {hare_wins/1000}%")
print(f"Tortoise wins: {tortoise_wins}| Percentage: {tortoise_wins/1000}%")
