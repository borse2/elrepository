#Boris Adokou
#Create a program that searches applicants' qualifications based off key words
# Applicant Names
names = [
...
qualified=[]
def qualifications(txt,years):
    for i in range(len(names)):
        if experience[i]>=years and txt in expertise[i]:
            qualified.append(names[i])
    print(qualified)
    qualified.clear()

qualifications("Python",0)
qualifications("Cyber Security",5)
